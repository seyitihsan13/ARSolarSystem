...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    override func viewDidLoad() {
       ...
       // let mySphere = createSphere(radius: 0.1, content: "wall.png", vector:   SCNVector3(0, 0.2, -1))
        ...
        let mars = createSphere(radius: 0.2, content: "mars.png", vector: SCNVector3(0.25, 0.2, -1))
        
        let venus = createSphere(radius: 0.3, content: "venus.png", vector: SCNVector3(1, 0.2, -1))
